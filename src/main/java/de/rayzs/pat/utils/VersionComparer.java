...
public class VersionComparer {
    ...
    public boolean computeComparison() {
        ...
        String result = new ConnectionBuilder().setUrl(versionUrl).setProperties("ProAntiTab", "4454").connect()
                .getResponse();
        ...
        if (VersionComparer.get().isNewer()) {
            ...
            if (shouldAnnounce) {
                ...
                Logger.info("§8[§fPAT | " + (Reflection.isProxyServer() ? "Proxy" : "Bukkit")
                        + "§8] §7Please be aware that you are currently using a §bdeveloper §7version of ProAntiTab. Bugs, errors and a lot of debug messages might be included.");
