...
public class PermissionUtil {
    ...
    public static boolean hasPermission(Object targetObj, String permission) {
        ...
        if (Storage.getPermissionPlugin() == PermissionPlugin.NONE) {
            ...
            return sender.isOperator() || sender.hasPermission("*") || sender.hasPermission("proantitab.*")
        ...
        if (sender != null) {
            ...
            if (Storage.getPermissionPlugin() != PermissionPlugin.LUCKPERMS) {
                ...
                if (!permissionMap.hasPermissionState("proantitab." + permission))
                    permissionMap.setState("proantitab." + permission,
                            sender.hasPermission("proantitab." + permission));
        ...
        return permissionMap.isPermitted("*") || permissionMap.isPermitted("proantitab.*")
