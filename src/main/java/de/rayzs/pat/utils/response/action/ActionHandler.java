...
public class ActionHandler {
    ...
    private static final Action ACTION = Reflection.isProxyServer()
            ? Reflection.isVelocityServer() ? new VelocityAction() : new BungeeAction()
            : Reflection.isAtMost(1, 16) ? new OldBukkitAction() : new ModernBukkitAction();
    ...
    public static void sendTitle(String action, UUID uuid, String command, String title, String subTitle, int fadeIn,
