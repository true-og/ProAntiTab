...
public class OldBukkitAction implements Action {
    ...
    @Override
    public void sendTitle(String action, UUID uuid, String command, String title, String subTitle, int fadeIn, int stay,
            int fadeOut)
    {
    ...
    public void sendActionbar(String action, UUID uuid, String command, String message) {
        ...
        try {
            ...
            Constructor<?> constructor = (Objects.<Class<?>>requireNonNull(
                    Class.forName("net.minecraft.server." + versionPackage + ".PacketPlayOutChat")))
                    .getConstructor(Class.forName("net.minecraft.server." + versionPackage + ".IChatBaseComponent"),
                            byte.class);
            Object iChatBaseComponent = (Objects
                    .requireNonNull(Class.forName("net.minecraft.server." + versionPackage + ".IChatBaseComponent")))
            ...
            playerConnection.getClass()
                    .getMethod("sendPacket", Class.forName("net.minecraft.server." + versionPackage + ".Packet"))
                    .invoke(playerConnection, actionbarPacket);
