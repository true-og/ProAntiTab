...
public class BukkitCommandNodeHelper {
    ...
    private Object createEmptyEntry() throws Exception {
        ...
        final Constructor<?> entryConstructor = entryClazz.getDeclaredConstructor(nodeStubClazz, int.class, int.class,
                int[].class);
    ...
    private static class Node {
        ...
        public Node getChild(String name) {
            ...
            return this.children.stream().filter(n -> n.getName() != null && n.getName().equals(name)).findFirst()
                    .orElse(null);
