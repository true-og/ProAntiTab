...
public class Communicator {
    ...
    public static class Backend2Proxy {
        ...
        public static void sendIdentityRequest() {
            ...
            get().send2Proxy(new CommunicationPackets.Backend2Proxy.IdentityRequestPacket(get().getId()));

        }

        public static void sendKeepAliveRequest() {

            get().send2Proxy(new CommunicationPackets.Backend2Proxy.KeepAlivePacket());
    ...
    public static class Proxy2Backend {
        ...
        public static void sendUpdateCommand() {
            ...
            get().send2AllClients(new CommunicationPackets.Proxy2Backend.UpdatePacket(null));
        ...
        public static void sendUpdateCommand(UUID playerId, String serverName) {
            ...
            clientInfo.send(new CommunicationPackets.Proxy2Backend.UpdatePacket(playerId));
        ...
        public static void sendDataSync() {
            ...
            Communicator.get().send2AllClients(Communicator.get().constructDataSyncPacket());
        ...
        public static void sendDataSync(String serverName) {
            ...
            clientInfo.send(Communicator.get().constructDataSyncPacket());
        ...
        public static void sendConsoleMessage(String serverName, String message) {
            ...
            clientInfo.send(new CommunicationPackets.Proxy2Backend.ConsoleMessagePacket(message));
        ...
        public static void sendExecutePlayerCommand(String serverName, UUID playerId, String command) {
            ...
            clientInfo.send(new CommunicationPackets.Proxy2Backend.ExecutePlayerCommandPacket(playerId, command));
        ...
        public static void sendExecuteConsoleCommand(String serverName, String command) {
            ...
            clientInfo.send(new CommunicationPackets.Proxy2Backend.ExecuteConsoleCommandPacket(command));
        ...
        public static void sendNotification(UUID playerId, String serverName, String command) {
            ...
            clientInfo.send(new CommunicationPackets.Proxy2Backend.NotificationPacket(playerId, command));
        ...
        if (incomingPacket instanceof CommunicationPackets.Backend2Proxy.IdentityRequestPacket packet) {
            ...
            if (!same) {
                ...
                registeredClientInfo
                        .send(new CommunicationPackets.Proxy2Backend.IdentityPacket(packet.serverId(), serverName));
