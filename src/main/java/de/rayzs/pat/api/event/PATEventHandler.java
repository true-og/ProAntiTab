...
public class PATEventHandler {
    ...
    public static FilteredTabCompletionEvent callFilteredTabCompletionEvents(Object senderObj, String cursor,
    ...
    public static ServerPlayersChangeEvent callServerPlayersChangeEvents(Object senderObj,
            ServerPlayersChangeEvent.Type type)
    {
    ...
    public static UpdatePlayerCommandsEvent callUpdatePlayerCommandsEvents(Object playerObj, List<String> commands,
            boolean serverBased)
    {

        UpdatePlayerCommandsEvent event = EmptyEvent.createEmptyUpdatePlayerCommandsEvent(playerObj, commands,
                serverBased);
    ...
    public static SentSyncEvent callSentSyncEvents(CommunicationPackets.Proxy2Backend.DataSyncPacket dataSyncPacket,
            String serverName)
    {
    ...
    public static ReceiveSyncEvent callReceiveSyncEvents(
            CommunicationPackets.Proxy2Backend.DataSyncPacket dataSyncPacket)
    {
    ...
    public static class EmptyEvent {
        ...
        public static ServerPlayersChangeEvent createEmptyServerPlayersChangeEvent(Object senderObj,
                ServerPlayersChangeEvent.Type type)
        {
        ...
        public static SentSyncEvent createEmptySentSyncEvent(
                CommunicationPackets.Proxy2Backend.DataSyncPacket dataSyncPacket, String serverName)
        {
        ...
        public static ReceiveSyncEvent createEmptyReceiveSyncEvent(
                CommunicationPackets.Proxy2Backend.DataSyncPacket dataSyncPacket)
        {
        ...
        public static UpdatePlayerCommandsEvent createEmptyUpdatePlayerCommandsEvent(Object playerObj,
                List<String> commands, boolean serverBased)
        {
        ...
        public static ExecuteCommandEvent createEmptyExecuteCommandEvent(Object senderObj, String command,
                boolean blocked, boolean notify)
        {
        ...
        public static FilteredSuggestionEvent createEmptyFilteredSuggestionEvent(Object senderObj,
        ...
        public static FilteredTabCompletionEvent createEmptyFilteredTabCompletion(Object senderObj, String cursor,
                List<String> completion)
        {
