...
public class UpdatePermissionsSection extends ConfigStorage {
    ...
    public void load() {
        ...
        UPDATE_SPECIFIC = new ConfigSectionHelper<String>(this, "specific-player", "&aUpdated %target%'s permissions!")
                .getOrSet();
        PLAYER_NOT_ONLINE = new ConfigSectionHelper<String>(this, "player-not-online", "&c%target% is not online!")
                .getOrSet();
