...
public class CustomVersionSection extends ConfigStorage {
    ...
    public void load() {
        ...
        COMMANDS = new MultipleMessagesHelper(this, "commands",
                Arrays.asList("icanhasbukkit", "about", "ver", "version"));
        MESSAGE = new MultipleMessagesHelper(this, "message",
                Collections.singletonList("&fThis server is running CraftBukkit version git-NasaSpigot-294 (MC: X)"));
