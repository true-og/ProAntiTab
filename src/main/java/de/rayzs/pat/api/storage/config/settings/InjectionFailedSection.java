...
public class InjectionFailedSection extends ConfigStorage {
    ...
    public void load() {
        ...
        KICK_MESSAGE = new ConfigSectionHelper<String>(this, "kick-message",
                "&cInjection process failed! Please reconnect.").getOrSet();
        CONSOLE_MESSAGE = new ConfigSectionHelper<String>(this, "console-message",
                "&cInjection process failed! (%player%)").getOrSet();
