...
public class UpdateSection extends ConfigStorage {
    ...
    public void load() {
        ...
        UPDATED = new MultipleMessagesHelper(this, "updated",
                Collections.singletonList("&aYou are using the newest version! ^^"));
        OUTDATED = new MultipleMessagesHelper(this, "outdated",
                Arrays.asList("&8[&4ProAntiTab&8] &cThere is a new version available! (%newest_version%)",
