...
public class PluginHiderPlus extends Converter {
    ...
    public void apply(CommandSender sender) {
        ...
        Storage.ConfigSections.Settings.TURN_BLACKLIST_TO_WHITELIST.getConfig()
                .setAndSave("turn-blacklist-to-whitelist", !blacklist);
        ...
        sender.sendMessage(
                "&e&lNotice: &7Since PluginHider+ both blocks certain commands and whitelist a few, the conversion into PAT's storage.yml format won't be accurate. Only whitelisted commands have been added, and blocked commands for everyone if the plugin was used in blacklist mode.");
