...
public class PaperServerListPing implements Listener {
    ...
    private static final ExpireCache<Integer, List<ProtocolHoverLine>> CACHED_PROTOCOL_NAMES = new ExpireCache<>(1,
            TimeUnit.SECONDS);
    ...
    public void onPaperServerListPing(PaperServerListPingEvent event) {
        ...
        String versionName = Storage.ConfigSections.Settings.CUSTOM_PROTOCOL_PING.PROTOCOL
                .replace("%online_extended%", String.valueOf(onlineExtend)).replace("%online%", String.valueOf(online))
                ...
                Storage.ConfigSections.Settings.CUSTOM_PROTOCOL_PING.PLAYERLIST.getLines().forEach(line -> {
                    ...
                    if (line.contains("%players%")) {
                        ...
                        if (playerName.contains("\n")) {
                            ...
                            nameSplit = nameSplit.length > 30 ? Arrays.copyOfRange(nameSplit, 0, 30) : nameSplit;
    ...
    private String replaceString(String string, int online, int onlineExtend, int max) {
        ...
        String replaced = string.replace("&", "§").replace("%online_extended%", String.valueOf(onlineExtend))
