...
public class BukkitAntiTabListener implements Listener {
    ...
    public void onPlayerCommandSend(PlayerCommandSendEvent event) {
        ...
        final List<String> playerCommands = COMMANDS_CACHE.getPlayerCommands(new ArrayList<>(event.getCommands()),
                sender, groups);
        final FilteredSuggestionEvent filteredSuggestionEvent = PATEventHandler.callFilteredSuggestionEvents(player,
                playerCommands);
