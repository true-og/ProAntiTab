...
public class BungeeMetrics {
    ...
    static {
                ...
                || !System.getProperty("bstats.relocatecheck").equals("false"))
        {
            ...
            final String defaultPackage = new String(
                    new byte[]
                    { 'o', 'r', 'g', '.', 'b', 's', 't', 'a', 't', 's', '.', 'b', 'u', 'n', 'g', 'e', 'e', 'c', 'o',
                            'r', 'd' });
            ...
            // package names
            if (BungeeMetrics.class.getPackage().getName().equals(defaultPackage)
                    || BungeeMetrics.class.getPackage().getName().equals(examplePackage))
            {
    ...
    public BungeeMetrics(Object pluginObj, int pluginId) {
        ...
        if (!(pluginObj instanceof Plugin))
            throw new IllegalArgumentException("pluginObj has an invalid instance!");
    ...
    private void startSubmitting() {
        ...
        plugin.getProxy().getScheduler().schedule(plugin, this::submitData, initialDelay + secondDelay, 1000 * 60 * 30,
