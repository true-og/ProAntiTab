...
public class NotifyCommand extends ProCommand {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        if (sender.isConsole()) {
            ...
            boolean backend = Storage.ConfigSections.Settings.HANDLE_THROUGH_PROXY.ENABLED
        ...
        String message = enabled ? Storage.ConfigSections.Messages.NOTIFICATION.DISABLED
