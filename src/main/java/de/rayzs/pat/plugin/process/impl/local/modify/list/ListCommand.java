...
public class ListCommand extends ProCommand {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        if (args.length == 0) {
            ...
            String commandsListMessage = StringUtils.getStringList(Storage.Blacklist.getBlacklist().getCommands(),
            ...
            message = StringUtils.replace(message, "%size%",
                    String.valueOf(Storage.Blacklist.getBlacklist().getCommands().size()), "%commands%",
                    commandsListMessage);
        ...
        String commandsListMessage = StringUtils.getStringList(group.getCommands(),
        ...
        message = StringUtils.replace(message, "%group%", groupName, "%size%",
                String.valueOf(group.getCommands().size()), "%commands%", commandsListMessage);
