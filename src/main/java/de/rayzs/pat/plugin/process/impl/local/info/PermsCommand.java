...
public class PermsCommand extends ProCommand {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        sender.sendMessage((online
                ? Storage.ConfigSections.Messages.PERMS_CHECK.MESSAGE.replace("%permissions%",
                        PermissionUtil.getPermissionsAsString(uuid))
                : Storage.ConfigSections.Messages.PERMS_CHECK.PLAYER_NOT_ONLINE).replace("%player%", name));
