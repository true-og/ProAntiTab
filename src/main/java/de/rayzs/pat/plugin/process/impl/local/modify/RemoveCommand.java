...
public class RemoveCommand extends ProCommand {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        if (length == 1) {
            ...
            String message = !exist ? Storage.ConfigSections.Messages.BLACKLIST.REMOVE_FAILED
                    : Storage.ConfigSections.Messages.BLACKLIST.REMOVE_SUCCESS;
        ...
        String message = !exist ? Storage.ConfigSections.Messages.GROUP.REMOVE_FAILED
                : Storage.ConfigSections.Messages.GROUP.REMOVE_SUCCESS;
    ...
    public List<String> tabComplete(CommandSender sender, String[] args) {
        ...
        if (args.length == 0 || args.length == 1 && !args[0].startsWith("\"")) {
            ...
            return new ArrayList<>(Storage.Blacklist.getBlacklist().getCommands()).stream()
                    .filter(str -> !str.contains(" ")).toList();
        ...
        if (args[0].startsWith("\"")) {
            ...
            if (lastIndex == -1) {
                ...
                if (args.length == 1) {
                    ...
                    Stream<String> stream = new ArrayList<>(Storage.Blacklist.getBlacklist().getCommands()).stream()
