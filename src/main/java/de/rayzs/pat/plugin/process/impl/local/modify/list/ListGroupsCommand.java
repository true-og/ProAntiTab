...
public class ListGroupsCommand extends ProCommand {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        String groupsListMessage = StringUtils.getStringList(GroupManager.getGroupNames(),
        ...
        message = StringUtils.replace(message, "%size%", String.valueOf(GroupManager.getGroups().size()), "%groups%",
                groupsListMessage);
